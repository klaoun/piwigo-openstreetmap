	...
	<fieldset>
		<ul>
			<li>
				...
				<small>Check out <a href="https://leaflet-extras.github.io/leaflet-providers/preview/" target="_blank">this example</a> with half a hundred different layers to choose from.|@translate</small>
			</li>
